    ...
    initialize: function(){
      ...
      ybotq.push(function () {
        if (window.innerWidth >= 768) {
          yieldbot.pub('4534');
          yieldbot.defineSlot('right1_300x250', {sizes: [[300, 250], [300, 600]]});
...
ami.ads.gpt.addSlot({
   ...
   if(window.innerWidth < 768){
     ami.ads.gpt.addSlot({
            ...
            targeting: [["pos","mobile_top"]]
        });

     ami.ads.gpt.addSlot({
            slotName: "mobile_bottom",
            adUnit: "/4216/mob.mensfitness/homepage",
            sizes: [[300, 50], [320, 50], [300, 100]],
            idSelector:"dfp-ad-mobile_bottom",
            targeting: [["pos","mobile_bottom"]]
        });
